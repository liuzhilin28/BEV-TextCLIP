...
class BEVTextCLIP(nn.Module):
    ...
    def __init__(
        ...
        text_pretrained: Optional[bool] = None,
        ...
        self.text_model_path = text_model_path or (
            "./models/clip" if text_pretrained else "./models/clip_random"
        )
        ...
        text_encoder_kwargs = {}
        if text_encoder_type == "local_clip":
            text_encoder_kwargs["model_path"] = self.text_model_path
        elif text_encoder_type == "clip":
            text_encoder_kwargs["model_name"] = self.text_model_name
